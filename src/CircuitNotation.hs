...
data PortDescription a
    ...
    -- ^ generated by @circuitS@: a value-boundary bus expression, tagged with
    -- 'SigTag' to pin the bus type to a signal
    | SigTagPat (LPat GhcPs)
    -- ^ generated by @circuitS@: a value-boundary bus pattern, tagged with
    -- 'SigTag' to pin the bus type to a signal
...
data ExternalNames = ExternalNames
  ...
  -- a signal; used at the value boundary of @circuitS@ blocks
